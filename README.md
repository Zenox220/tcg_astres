...
## Version V42 — Paquets Basic, Premium, Élite et héros déblocables

La V42 ajoute trois formats de paquets, une boutique de héros, le verrouillage des héros non obtenus et les récompenses de type héros dans les outils LiveOps. Consultez `HEROES_PACKS_V42.md` pour les détails de configuration et de déploiement.

## Version V43 — Six héros supplémentaires

La V43 ajoute Grikz le Bricoleur, Thorga l’Appel-esprits, Nyx l’Œil voilé, Kael Brisefer, Xal’gor le Dévoreur et AX-7, Oracle mécanique, chacun avec un pouvoir héroïque distinct. Consultez `HEROES_V43.md` pour les identifiants et les chemins d’images.

## Version V44 — Modes de combat

La V44 ajoute le sous-menu **Modes** pour les parties solo et multijoueur, avec **Bras de fer**, **Sans Répis**, **Furie des decks** et le mode autobattler complet **Le Tavernier**. Consultez `MODES_V44.md` pour les règles et `TESTS_MODES_V44.txt` pour les contrôles effectués.
