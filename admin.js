...
(() => {
  ...
  const ids = [
    ...
    "admin-popup-reward-enabled", "admin-popup-reward-fields", "admin-popup-reward-type", "admin-popup-reward-amount", "admin-popup-reward-pack-wrap", "admin-popup-reward-pack-id", "admin-popup-reward-card-wrap", "admin-popup-reward-card-id",
  ...
  function readPopupReward() {
    ...
    return [{ type, cardId: dom.adminPopupRewardCardId.value, amount }];
  }
