/*
  ...
  - Invocation de chaque serviteur : audio/cards/nom_de_la_carte.mp3 (ou .ogg / .wav)
...
window.ASTREA_AUDIO_CONFIG = {
  ...
  /*
    ...
    Sans réglage ici, le jeu cherche automatiquement dans audio/cards/ puis dans audio/cartes/.

    Exemple :
    cardSummons: {
      "creature_001": ["audio/cards/etincelle_familiere.mp3"],
      "Titan des constellations": ["audio/cards/voix_du_titan.ogg"]
    }
  */
  cardSummons: {}
};
